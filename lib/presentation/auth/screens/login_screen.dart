                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 16),
                      const Text('نظام إدارة مزودي الخدمة', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white)),
                    const SizedBox(height: 8),
                    const Text('لإدارة شبكات MikroTik', style: TextStyle(fontSize: 14, color: Colors.white70)),
                            ...
                            Align(
                              ...
                              child: TextButton(
                                onPressed: authState.isLoading ? null : () {
                                  ...
                                  if (email.isEmpty) {
                                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('أدخل البريد الإلكتروني أولاً')));
                                    return;
                                  }
